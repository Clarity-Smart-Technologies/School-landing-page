        ...
        <section className="relative py-12 overflow-hidden bg-black sm:py-16 lg:py-20 xl:py-24">
            ...
            <div className="relative px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="max-w-5xl mx-auto text-center">
                    <h2 className="text-3xl font-normal text-white sm:text-5xl lg:text-6xl xl:text-7xl">Get Proven Results</h2>
                    ...
                    <div className="grid grid-cols-1 px-12 mt-12 md:px-0 gap-y-8 md:grid-cols-3 sm:mt-16 lg:mt-20 xl:mt-24">
                        <div className="md:pr-8 lg:pr-12">
                            ...
                            <p className="mt-4 text-base font-normal text-gray-400">Amet minim mollit non deserunt ullamco est sit aliqua.</p>
                        </div>

                        <div className="w-48 h-px mx-auto bg-gray-900 md:hidden"></div>

                        <div className="md:border-gray-900 md:border-l lg:px-12 md:px-8">
                            <h3 className="text-2xl font-normal text-white">Find better opportunites quickly</h3>
                            <p className="mt-4 text-base font-normal text-gray-400">Amet minim mollit non deserunt ullamco est sit aliqua.</p>
                        </div>
                        ...
                        <div className="md:border-gray-900 md:border-l lg:pl-12 md:pl-8">
                            <h3 className="text-2xl font-normal text-white">Get proven path for growing business</h3>
                            <p className="mt-4 text-base font-normal text-gray-400">Amet minim mollit non deserunt ullamco est sit aliqua.</p>
                        </div>
                    </div>
                    ...
                    <div className="max-w-3xl mx-auto mt-8 sm:mt-12">
                        <p className="max-w-xl mx-auto text-xl font-normal text-white sm:text-2xl lg:text-3xl lg:max-w-none">We have very limited seats for booking calls. If you dont want to miss the chance, get a seat right now.</p>
                        <div className="mt-12">
                            <a href="#" title="" className="inline-flex items-center justify-center px-8 py-4 text-base font-normal text-white transition-all duration-200 rounded-full bg-gradient-to-r from-cyan-500 to-purple-500 hover:contrast-150" role="button"> Get your free seat </a>
                        </div>
                    </div>
                </div>
            </div>
