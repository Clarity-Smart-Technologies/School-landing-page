		...
		>
			...
			<div className="w-1/2 grid gap-8">
				...
				<div className="bg-white shadow-lg text-black p-10">
					<h2 className="font-semibold text-xl text-primary">Let's do this</h2>
					<p className="my-4">Elevate yourself, your family, and your community with The Sherpherd's Online School. Begin your journey towards transformation with us, an online university tailored for working adults.</p>
